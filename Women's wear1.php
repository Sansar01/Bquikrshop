...
$code = $_POST['code'];
$sql="SELECT * FROM `prithviraj` WHERE `code`='$code'";
...
<head>
    ...
    <body>
        ...
        <center>
            <img src="
                    https://st4.depositphotos.com/8152166/24742/v/600/depositphotos_247425594-stock-illustration-sisterhood-feminism-gender-equality-set.jpg" class="img">
            <font face=" Lucida calligraphy " style="font-size:5vw; ">Women's
        ...
        <div id="demo" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="https://images.financialexpress.com/2016/10/shopclues-deal-3.jpg" alt="Los Angeles" width="1100" height="500">
                </div>
                <div class="carousel-item">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcThVbLuHeH-b_M2KLty6SU_Mok5PoIQ346TxQ&usqp=CAU" alt="Chicago" width="1100" height="500">
                </div>
                <div class="carousel-item">
                    <img src="https://i.etsystatic.com/19407216/r/il/8eb3ca/2614751176/il_340x270.2614751176_1zah.jpg" alt="html" width="1100" height="500">
                </div>
            </div>
...
?>
<div class="cart_div">
<a href="Pcart.php"><img src="cart-icon.png" /> Cart<span><?php echo $cart_count; ?></span></a>
</div>
<?php
}
$sql="SELECT * FROM prithviraj where id>=46 and id<=54";
$result = mysqli_query($con,$sql);
while($row = mysqli_fetch_assoc($result)){
        echo "<div class='product_wrapper'>
            <form method='post' action=''>
            <input type='hidden' name='code' value=".$row['code']." />
            <div class='image'><img src='     ".$row['image']."    ' 'width='180px' height='200' style='padding:10px'/></div>
