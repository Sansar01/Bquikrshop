        ...
        <div id="demo" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="https://cdn.shopify.com/s/files/1/0086/0150/1792/files/5._BOYS_SMART_CASUAL_4ef778fd-2f2a-4395-8277-b052865ae5fb_1024x1024_crop_center.png?v=1619506883" alt="Los Angeles" width="1100" height="500">
                </div>
                <div class="carousel-item">
                    <img src="https://images.freekaamaal.com/post_images/1605784309.jpg" alt="Chicago" width="1100" height="500">
                </div>
                <div class="carousel-item">
                    <img src="https://img1.junaroad.com//assets/images/mobileNotif/img-1631080035999.jpg?page_id=2391766&crsl_pos=1" alt="html" width="1100" height="500">
                </div>
            </div>
...
$sql="SELECT * FROM rajgharna where id>=28 and id<=36";
$result = mysqli_query($con,$sql);
