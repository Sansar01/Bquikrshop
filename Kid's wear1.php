...
<head>
    ...
    <body>
        ...
        <br>
        <center>
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQCc_fbo3SE_MqnzGjLHQTE3rQXNWY2-r1-4Q&usqp=CAU" class="img">
            <font face=" Lucida calligraphy " style="font-size:5vw; ">Kid's
        ...
        <div id="demo" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="https://www.go4india.net/images/kids-clothes-online-india.jpg" alt="Los Angeles" width="1100" height="500">
                </div>
                <div class="carousel-item">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR0mAcyvU5O4I4bENZmWxhUODAbyX0mUtJfNg&usqp=CAU" alt="Chicago" width="1100" height="500">
                </div>
                <div class="carousel-item">
                    <img src="https://www.pinkblueindia.com/blog/wp-content/uploads/2017/07/baby-girl-pincess-party-dresses-gowns-kolkata.jpg" alt="html" width="1100" height="500">
                </div>
            </div>
...
$sql="SELECT * FROM prithviraj where id>=55 and id<=63";
$result = mysqli_query($con,$sql);
while($row = mysqli_fetch_assoc($result)){
        echo "<div class='product_wrapper'>
            <form method='post' action=''>
            <input type='hidden' name='code' value=".$row['code']." />
            <div class='image'><img src='     ".$row['image']."    ' 'width='250px' height='200' style='padding:10px'/></div>
