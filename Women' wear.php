        ...
        <div id="demo" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="https://g3fashion.cdn.imgeng.in//upload/admin/slider/1630127300_Womens-Best-Seller-M.jpg" alt="Los Angeles" width="1100" height="500">
                </div>
                <div class="carousel-item">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSqLgy7mZZiw5rB3BiXsXpWePU7YQAbzWno5w&usqp=CAU" alt="Chicago" width="1100" height="500">
                </div>
                <div class="carousel-item">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRGIAs_xMhKst0GxG0wpNBuXCXar7PLvY3jng&usqp=CAU" alt="html" width="1100" height="500">
                </div>
            </div>
...
$sql="SELECT * FROM rajgharna where id>=19 and id<=27";
$result = mysqli_query($con,$sql);
