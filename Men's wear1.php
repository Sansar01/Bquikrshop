        ...
        <div id="demo" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="https://www.greatbuyz.com/blog/wp-content/uploads/2019/09/Best-Mens-Clothing-.png" alt="Los Angeles" width="1100" height="500">
                </div>
                <div class="carousel-item">
                    <img src="https://img.mensxp.com/media/content/2016/Dec/best-online-shopping-sites-for-men-980x457-1481709884.jpg" alt="Chicago" width="1100" height="500">
                </div>
                <div class="carousel-item">
                    <img src="https://assetscdn1.paytm.com/images/catalog/view_item/409284/1557336782049.jpg?imwidth=1600&impolicy=hq" alt="New York" width="1100" height="500">
                </div>
            </div>
...
$sql="SELECT * FROM prithviraj where id>=37 and id<=45";
$result = mysqli_query($con,$sql);
